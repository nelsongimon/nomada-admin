...
interface FormEditAttributeValueProps {
  closeModal: () => void;
  value: AttributeValue;
}

export default function FormEditAttributeValue({
  closeModal,
  value
}: FormEditAttributeValueProps) {
  ...
  const handleSubmit = (event: any) => {
    ...
    router.post(route('attribute-values.update', value.id), {
      _method: "patch",
      ...data,
    }, {
