...
export default function CreateProduct({ auth, categories, styles, tags, attributes }: PageProps) {
                            ...
                            <div className="flex flex-col gap-y-3">
                              {attribute.attribute_values.map((value) => (
                                <div key={value.id} className="flex gap-x-2 items-center">
                                  <Checkbox id={value.slug} onCheckedChange={(checked) => handleCheckedChange(checked as boolean, value.id)} />
